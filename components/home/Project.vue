<template>
  <div class="card rounded-2xl px-3 py-3 mt-28 w-72">
    ...
    <div class="mt-4 text-basic-02">
      ...
      <a class="inline-block w-full bg-basic-02 text-white font-semibold text-center rounded-xl mt-2 py-1"
        href="#">الدخول</a>
    </div>
  </div>
</template>
...
<style>
  .card{
    box-shadow: #cca35a 0px 4px 8px -2px, #cca35a 0px 0px 0px 1px;
  }
</style>